...
@interface QinGCDTimer()
@property (nonatomic, strong) NSMutableDictionary *timerContainer;
@property (nonatomic, strong) NSMutableDictionary *actionBlockCache;
@end

@implementation QinGCDTimer

#pragma mark - Public Method

+ (QinGCDTimer *)sharedInstance
{
    static QinGCDTimer *_gcdTimerManager = nil;
    static dispatch_once_t onceToken;

    dispatch_once(&onceToken,^{
        _gcdTimerManager = [[QinGCDTimer alloc] init];
    });
